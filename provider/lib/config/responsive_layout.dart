  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        // Keep visual proportions on small screens without leaving an empty
        // strip at the bottom.
        // Avoid scaling transformed text inputs while IME is visible because
        // some Android devices can lose focus/keyboard behavior in that case.
